        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <form action="alterar_conta.php" method="post">
                    ...
                    <div class="form-group">
                        <label>Digite o Saldo (R$):</labe>
                        <input class="form-control" placeholder="Digite o Saldo aqui..." name="saldo" id="saldo" value="<?= $dados[0]['saldo_conta'] ?>"/>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Você Realmente Deseja Exluir Sua Conta Bancária?</h4>
                                </div>
                                <div class="modal-body">
                                    <span>Nome do Banco: </span><strong><?= $dados[0] ['banco_conta'] ?>.</strong>
                                    <br>
                                    <span>Número da Agência: </span><strong><?= $dados[0] ['agencia_conta'] ?>.</strong>
                                    <br>
