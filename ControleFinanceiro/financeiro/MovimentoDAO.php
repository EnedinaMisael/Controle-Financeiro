    ...
    class MovimentoDao extends Conexao{
        public function RealizarMovimento($tipo, $data, $valor, $obs, $categoria, $empresa, $conta){
            if($tipo == '' || $data == '' || $valor == '' || $categoria == '' || $empresa == '' || $conta == ''){
                ...
                // Função nativa do PHP para monitorar e manter a segurança dos dados e da ação execuatada!
                ...
                try{
                    ...
                    // Caso algum problema aconteça, todo o processo sera cancelado e a integridade dos dados mantida!
                    $conexao->rollBack();
