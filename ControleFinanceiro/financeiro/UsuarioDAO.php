    ...
    class UsuarioDAO extends Conexao{
        public function ValidarLogin($email, $senha){
            if($email == '' || $senha == ''){
                ...
                //cria uma Variavel para receber o Array do PDO
                $user = $sql->fetchAll();
        ...
        public function CarregarMeusDados(){
            ...
            //comando realiza consulta via PDO no Banco de Dados e retorna um Array com os dados encontrados
            $sql->setFetchMode(PDO::FETCH_ASSOC);
        ...
        // Essa funcao vai impedir que um cadastro seja feito com um e-mail que ja exista na base de dados!
        ...
        // Essa function vai impedir que uma alteração seja realizada com um e-mail que ja exista na base de dados!
